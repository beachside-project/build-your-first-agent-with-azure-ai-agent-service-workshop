...
2.  **ツール**セクションには、「製品およびカテゴリに関する競合インサイト」が含まれるようになり、Agentは次のことができるようになります：

      * Grounding with Bing Search を使用して、競合他社の製品名、会社名、価格を収集します。
...
4.  **競合他社の初心者向けテントと同様の価格帯で、私たちが地域別に販売しているテントを表示して**
